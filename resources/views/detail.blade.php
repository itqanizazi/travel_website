          ...
          <div class="col-12 col-md-12 col-lg-5">
            <div class="card bordered card-form" style="padding: 30px 40px">
             ...
             <div class="card-bank d-flex align-items-center justify-content-around">
              ...
              <a onClick="return confirm('Apakah anda sudah membayar ?')" class="btn btn-book btn-block mt-3" href="https://api.whatsapp.com/send?phone=6281999483864&text= Saya mau pesan travel package {{ $travelPackage->name }} berikut bukti pembayaran saya ! " target="_blank"
                >Continue to Book</a
              >
            </div>
          </div>
